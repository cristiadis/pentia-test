...
const Intro: React.FunctionComponent = (props) => {
  return (
    <>
      ...
      <BodyText>Hvordan bliver din virksomhed en digital vinder i fremtiden? Hvilke tiltag skal der til strategisk og taktisk for at dreje forretningen i den rigtige retning?
